...
define razjarennye_dvorniki = Character("razjarennye_dvorniki_var", color="#F13A13", dynamic=True)
define goluboj = Character("goluboj_var", color="#232C16", dynamic=True)
define gospodin = Character("gospodin_var", color="#182D83", dynamic=True)
define hozjain_trete_videnie = Character("hozjain_trete_videnie_var", color="#1CAA15", dynamic=True)
define gost = Character("gost_var", color="#4AA750", dynamic=True)
define zhorzh = Character("zhorzh_var", color="#D2C20A", dynamic=True)
define misha = Character("misha_var", color="#E31244", dynamic=True)
define starik = Character("starik_var", color="#09DF8F", dynamic=True)
define ryzhij_gospodin = Character("ryzhij_gospodin_var", color="#19AF6A", dynamic=True)
define drugoj_trete_videnie = Character("drugoj_trete_videnie_var", color="#0CDFDB", dynamic=True)
define devushka = Character("devushka_var", color="#C19F7F", dynamic=True)
define neznakomka = Character("neznakomka_var", color="#54ECE1", dynamic=True)
define hozjajka = Character("hozjajka_var", color="#04E608", dynamic=True)
define dama = Character("dama_var", color="#B8DD03", dynamic=True)
define raznye_golosa = Character("raznye_golosa_var", color="#22D0C2", dynamic=True)
define kto_to = Character("kto_to_var", color="#C0A8F1", dynamic=True)
...
label Act_1:
    ...
    devushka "...только она, милый мой, вышла, хвать — забыла хозяйку пивом угостить. Сейчас — назад, а уж он комод открыл, да и роется, все перерыл, все перерыл, думал — не скоро вернется... Она, милый мой, кричать, а он, милый мой, ей рот зажимать.(Продолжает быстро рассказывать мужчине.) ...только она, милый мой, вышла, хвать — забыла хозяйку пивом угостить. Сейчас — назад, а уж он комод открыл, да и роется, все перерыл, все перерыл, думал — не скоро вернется... Она, милый мой, кричать, а он, милый мой, ей рот зажимать. Ну, все-таки хозяйка прибежала, да сама кричать, да дворника позвала; так его, милый мой, сейчас в участок... (Быстро прерывает.) Дай двугривенный."

    devushka "Ну, все-таки хозяйка прибежала, да сама кричать, да дворника позвала; так его, милый мой, сейчас в участок... (Продолжает быстро рассказывать мужчине.) ...только она, милый мой, вышла, хвать — забыла хозяйку пивом угостить. Сейчас — назад, а уж он комод открыл, да и роется, все перерыл, все перерыл, думал — не скоро вернется... Она, милый мой, кричать, а он, милый мой, ей рот зажимать. Ну, все-таки хозяйка прибежала, да сама кричать, да дворника позвала; так его, милый мой, сейчас в участок... (Быстро прерывает.) Дай двугривенный."
    ...
    devushka "Дай двугривенный.(Продолжает быстро рассказывать мужчине.) ...только она, милый мой, вышла, хвать — забыла хозяйку пивом угостить. Сейчас — назад, а уж он комод открыл, да и роется, все перерыл, все перерыл, думал — не скоро вернется... Она, милый мой, кричать, а он, милый мой, ей рот зажимать. Ну, все-таки хозяйка прибежала, да сама кричать, да дворника позвала; так его, милый мой, сейчас в участок... (Быстро прерывает.) Дай двугривенный."
    ...
    chelovek_v_palto "Государи мои! Есть у меня небольшая вещица — весьма ценная миниатюра. (Вытаскивает из кармана камею.) Вот-с, не угодно ли: с одной стороны — изображение эмблемы, а с другой — приятная дама в тюнике на земном шаре сидит и над этим шаром держит скипетр: подчиняйтесь, мол, повинуйтесь — и больше ничего!"
    ...
    chelovek_v_palto "Вот-с, не угодно ли: с одной стороны — изображение эмблемы, а с другой — приятная дама в тюнике на земном шаре сидит и над этим шаром держит скипетр: подчиняйтесь, мол, повинуйтесь — и больше ничего!(Вытаскивает из кармана камею.) Вот-с, не угодно ли: с одной стороны — изображение эмблемы, а с другой — приятная дама в тюнике на земном шаре сидит и над этим шаром держит скипетр: подчиняйтесь, мол, повинуйтесь — и больше ничего!"
    ...
    pervyj "А теперь пришло время нам повеселиться. Ну, Ваня, слушай (торжественно развертывает журнал и читает:) «Любящие супруги. Муж: — Ты, милочка, зайди сегодня к мамаше и попроси ее...»"
    ...
    pervyj "«Любящие супруги. Муж: — Ты, милочка, зайди сегодня к мамаше и попроси ее...»(торжественно развертывает журнал и читает:) «Любящие супруги. Муж: — Ты, милочка, зайди сегодня к мамаше и попроси ее...»"
    ...
    pervyj "«Жена: — Что ты, милочка! Катеньке уж скоро двадцать лет. (Еле может прочесть от смеха.) Ей уж не куколку, а женишка пора подарить»."
    ...
    pervyj "Ей уж не куколку, а женишка пора подарить».(Еле может прочесть от смеха.) Ей уж не куколку, а женишка пора подарить»."
    ...
    seminarist "Танцует... Танцует... Я на шарманке, а она под шарманку. (Делает пьяные жесты, как будто что-то ловит.) Вот, не поймал... опять не поймал... но и вам, черти, не поймать, если уж мне не поймать..."
    ...
    seminarist "Вот, не поймал... опять не поймал... но и вам, черти, не поймать, если уж мне не поймать...(Делает пьяные жесты, как будто что-то ловит.) Вот, не поймал... опять не поймал... но и вам, черти, не поймать, если уж мне не поймать..."
    ...
    chelovek_v_palto "Нет-с, я любитель! Люблю острый сыр, знаете, такой круглый! (Делает кругообразные жесты.) Забыл название."
    ...
    chelovek_v_palto "Забыл название.(Делает кругообразные жесты.) Забыл название."
    ...
    sobesednik "А знаете... люксем-бургский... так пахнет нехорошо... и шевелится, шевелится... (Чмокает губами, шевелит пальцами.)"
    ...
    chelovek_v_palto "Швейцарский!.. Вот что-с! (Щелкает пальцами.)"
    ...
    poet "<{i}Весь кабачок как будто нырнул куда-то. Стены расступаются. Окончательно наклонившийся потолок открывает небо — зимнее, синее, холодное. В голубых вечерних снегах открывается —{/i}>"
...
label Act_2:
    ...
    poet "<{i}Оба грустят под голубым снегом. Пропадают в нем. И снег грустит. Он запорошил уже и мост, и корабли. Он построил белые стены на канве деревьев, вдоль стен домов, на телеграфных проволоках.{/i}>"
    ...
    poet "<{i}И даль земная и даль речная поднялись белыми стенами, так что все бело, кроме сигнальных огней на кораблях и освещенных окон домов. Снежные стены уплотняются. Они кажутся близкими одна к другой. Понемногу открывается —{/i}>"
...
label Act_3:
    ...
    hozjajka "CherДорогой (франц.). – Ред. Иван Павлович! Идите скорее! Только вас и ждали! Вот, Аркадий Романович обещался нам сегодня спеть!"

    hozjajka "{a=myshow|tooltip|text=Дорогой (франц.). – Ред.}Иван Павлович! Идите скорее! Только вас и ждали! Вот, Аркадий Романович обещался нам сегодня спеть!Дорогой (франц.). – Ред. Иван Павлович! Идите скорее! Только вас и ждали! Вот, Аркадий Романович обещался нам сегодня спеть{/a}!"
    ...
    zhorzh "Мечтатель! Завел машину. Строишь какие-то теории и ничего не слушаешь и не видишь. Я о музыке даже не говорю, и мне в конце концов наплевать! И я был бы очень рад видеть все это в отдельном кабинете.(Миша рассеянно шарит в корзинке с бисквитами.) Послушай, оставь бисквиты. Ведь противно есть, если все перетрогаешь. Смотри, как на тебя смотрит кузина. А все оттого, что ты рассеян. Эх, мечтатели."

    zhorzh "Но согласись же, не объявить на афише, что Серпантини будет завернута в одну тряпку, — это значит поставить всех в пренеловкое положение. Если б я знал, я не повел бы туда мою невесту. (Миша рассеянно шарит в корзинке с бисквитами.) Послушай, оставь бисквиты. Ведь противно есть, если все перетрогаешь. Смотри, как на тебя смотрит кузина. А все оттого, что ты рассеян. Эх, мечтатели."
    ...
    zhorzh "Послушай, оставь бисквиты. Ведь противно есть, если все перетрогаешь. Смотри, как на тебя смотрит кузина. А все оттого, что ты рассеян. Эх, мечтатели.(Миша рассеянно шарит в корзинке с бисквитами.) Послушай, оставь бисквиты. Ведь противно есть, если все перетрогаешь. Смотри, как на тебя смотрит кузина. А все оттого, что ты рассеян. Эх, мечтатели."
    ...
    hozjajka "Ах, дядя, перестаньте! Вы всех окончательно спугнете... Господа! Обновим наш разговор... (Поэту.) Вы прочтете нам что-нибудь, не правда ли?"
    ...
    hozjajka "Вы прочтете нам что-нибудь, не правда ли?(Поэту.) Вы прочтете нам что-нибудь, не правда ли?"
    ...
    poet "<{i}Никто не выражает неудовольствия. Поэт подходит к хозяйке, которая некоторое время делает умоляющие жесты, но скоро перестает. Поэт спокойно садится в дальний угол. Задумчиво смотрит на Незнакомку. Горничная разносит, что полагается.{/i}>"
    ...
    poet "<{i}Из общего бессмысленного говора вырывается хохот, отдельные слова и целые фразы:{/i}>"
    ...
    hozjajka "<{i}У темной занавеси уже нет никого. За окном горит яркая звезда. Падает голубой снег, такой же голубой, как вицмундир исчезнувшего Звездочета.{/i}>"
